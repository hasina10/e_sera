...
public class FollowersFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_followers);
        initializeView();
    ...
    private void initializeView() {
        followsList = (RecyclerView) mView.findViewById(R.id.followersList);
