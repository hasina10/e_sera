...
public class ViewAudio1 extends Animation {

    public static boolean NEED_PROXY = Build.VERSION.SDK_INT < 11;

    private static final WeakHashMap<View, ViewAudio1> PROXIES = new WeakHashMap<View, ViewAudio1>();

    public static ViewAudio1 wrap(View view) {
        ViewAudio1 proxy = PROXIES.get(view);
        Animation animation = view.getAnimation();
        if (proxy == null || proxy != animation && animation != null) {
            proxy = new ViewAudio1(view);
